  ...
  return (
    <div>
      <Layout title={"Create Product - Ecommerce App"}>
        <div className='createprod-container' style={{height:"100%"}}>
          <div className="createprodrow">
            <div className="createprodleft">
              <AdminMenu />
            </div>
            <div className="createprodright" style={{height:"100%",marginTop:"10px"}}>
