...
const UpdateProduct = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      //  const { data } = await axios.put( `/api/v1/products/update-product/${params.name}`,{name,description,price,quantity,shipping,category,photo : file.name});
      const id = params.id;
  ...
  return (
    <div>
      <Layout title={"Update Product - Ecommerce App"}>
        <div className="updprod-container" style={{ padding: "50px 0px" }}>
          <div className="updprodrow">
            <div className="updprodleft">
              <AdminMenu />
            </div>
            <div className="updprodright">
              <div className="update-container">
                <form>
                 <p style={{color:"white"}}>Select category:</p> 
                  ...
                  <div>
                    {/* {file ? (
                      ...
                      <>
                        <div>
                          <img
                            src={`http://localhost:4000/upload/${file}`}
                            alt="product photo"
                            height={"200px"}
                            width={"200px"}
                          />
                  ...
                  <p style={{color:"white"}}>Select shipping:</p> 
                    <Select
                    ...
                    <div className="updbtnset">
                      <div>
                        <button onClick={handleUpdate}>Update Product</button>
                      </div>
                      <div>
                        <button onClick={handleDelete} className="proddel">
                          Delete Product
                        </button>
                      </div>
                    </div>
